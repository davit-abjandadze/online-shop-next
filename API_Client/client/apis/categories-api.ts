...
export const CategoriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @summary კატეგორიების ბრტყელი, გვერდიანი სია
        ...
        /**
         * 
         * @summary კატეგორიის მიღება slug-ით
         * @param {string} slug 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        categoryControllerFindBySlug: async (slug: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'slug' is not null or undefined
            assertParamExists('categoryControllerFindBySlug', 'slug', slug)
            const localVarPath = `/categories/by-slug/{slug}`
        ...
        /**
         * 
         * @summary კატეგორიების სრული nested ხე
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        categoryControllerFindTree: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
        ...
        /**
         * 
         * @summary კატეგორიის (+ ქვეკატეგორიების) filter-adjustable attribute-ები, options + faceted counts, მიმდინარე query-ის გათვალისწინებით
         * @param {string} slug 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        categoryControllerGetFilters: async (slug: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'slug' is not null or undefined
            assertParamExists('categoryControllerGetFilters', 'slug', slug)
            const localVarPath = `/categories/{slug}/filters`
                .replace('{slug}', encodeURIComponent(String(slug)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        /**
         * 
         * @summary კატეგორიის (+ ქვეკატეგორიების) filtered+paginated პროდუქტების სია
         * @param {string} slug 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        categoryControllerGetProducts: async (slug: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'slug' is not null or undefined
            assertParamExists('categoryControllerGetProducts', 'slug', slug)
        ...
        /**
         * 
         * @summary კატეგორიის წაშლა (ADMIN)
         * @param {string} id 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const CategoriesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async categoryControllerFindBySlug(slug: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.categoryControllerFindBySlug(slug, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CategoriesApi.categoryControllerFindBySlug']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async categoryControllerFindTree(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.categoryControllerFindTree(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CategoriesApi.categoryControllerFindTree']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async categoryControllerGetFilters(slug: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.categoryControllerGetFilters(slug, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CategoriesApi.categoryControllerGetFilters']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async categoryControllerGetProducts(slug: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.categoryControllerGetProducts(slug, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CategoriesApi.categoryControllerGetProducts']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const CategoriesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        categoryControllerFindBySlug(slug: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.categoryControllerFindBySlug(slug, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary კონკრეტული კატეგორიის მიღება
         ...
         * @throws {RequiredError}
         */
        categoryControllerFindTree(options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.categoryControllerFindTree(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary კატეგორიის (+ ქვეკატეგორიების) filter-adjustable attribute-ები, options + faceted counts, მიმდინარე query-ის გათვალისწინებით
         ...
         * @throws {RequiredError}
         */
        categoryControllerGetFilters(slug: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.categoryControllerGetFilters(slug, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary კატეგორიის (+ ქვეკატეგორიების) filtered+paginated პროდუქტების სია
         ...
         * @throws {RequiredError}
         */
        categoryControllerGetProducts(slug: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.categoryControllerGetProducts(slug, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary კატეგორიის წაშლა (ADMIN)
...
export class CategoriesApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public categoryControllerFindBySlug(slug: string, options?: RawAxiosRequestConfig) {
        return CategoriesApiFp(this.configuration).categoryControllerFindBySlug(slug, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public categoryControllerFindTree(options?: RawAxiosRequestConfig) {
        return CategoriesApiFp(this.configuration).categoryControllerFindTree(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public categoryControllerGetFilters(slug: string, options?: RawAxiosRequestConfig) {
        return CategoriesApiFp(this.configuration).categoryControllerGetFilters(slug, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public categoryControllerGetProducts(slug: string, options?: RawAxiosRequestConfig) {
        return CategoriesApiFp(this.configuration).categoryControllerGetProducts(slug, options).then((request) => request(this.axios, this.basePath));
    }
...
export const CategoryControllerFindAllOrderEnum = {
    Asc: 'ASC',
    Desc: 'DESC',
} as const;
export type CategoryControllerFindAllOrderEnum = typeof CategoryControllerFindAllOrderEnum[keyof typeof CategoryControllerFindAllOrderEnum];
