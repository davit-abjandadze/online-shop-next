...
exports.AuthApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        authControllerChangePassword: function (body, options) {
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (body === null || body === undefined) {
                                throw new base_1.RequiredError('body', 'Required parameter body was null or undefined when calling authControllerChangePassword.');
                            }
         ...
         * @throws {RequiredError}
         */
        authControllerGetAdminDashboard: function (options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
         ...
         * @throws {RequiredError}
         */
        authControllerGetProfile: function (options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, accessToken, _a, query, key, key, headersFromBaseOptions;
                return __generator(this, function (_b) {
         ...
         * @throws {RequiredError}
         */
        authControllerRegister: function (body, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, query, key, key, headersFromBaseOptions, needsSerialization;
                return __generator(this, function (_a) {
                    // verify required parameter 'body' is not null or undefined
                    if (body === null || body === undefined) {
                        throw new base_1.RequiredError('body', 'Required parameter body was null or undefined when calling authControllerRegister.');
                    }
    ...
    return {
        ...
        authControllerGetAdminDashboard: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.AuthApiAxiosParamCreator(configuration).authControllerGetAdminDashboard(options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
        ...
        authControllerGetProfile: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.AuthApiAxiosParamCreator(configuration).authControllerGetProfile(options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
        ...
        authControllerLogin: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.AuthApiAxiosParamCreator(configuration).authControllerLogin(body, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
        ...
        authControllerRegister: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.AuthApiAxiosParamCreator(configuration).authControllerRegister(body, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
...
exports.AuthApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        authControllerGetAdminDashboard: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.AuthApiFp(configuration).authControllerGetAdminDashboard(options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        authControllerGetProfile: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.AuthApiFp(configuration).authControllerGetProfile(options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        authControllerLogin: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.AuthApiFp(configuration).authControllerLogin(body, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
...
var AuthApi = /** @class */ (function (_super) {
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.authControllerChangePassword = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.authControllerGetAdminDashboard = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, exports.AuthApiFp(this.configuration).authControllerGetAdminDashboard(options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.authControllerGetProfile = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, exports.AuthApiFp(this.configuration).authControllerGetProfile(options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.authControllerLogin = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, exports.AuthApiFp(this.configuration).authControllerLogin(body, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.authControllerRegister = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
