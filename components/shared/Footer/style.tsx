...
/* Footer-ს განზრახ აქვს ფიქსირებული მუქი ნავი ფონი, თემისგან დამოუკიდებელი —
   Nova-დიზაინის მიხედვით ეს ბრენდის ვიზუალური "წამყვანი" ელემენტია, არა
   light/dark რეჟიმზე მორგებადი ზედაპირი. */
